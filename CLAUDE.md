...
This project is indexed by GitNexus as **memesis** (34028 symbols, 59092 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
