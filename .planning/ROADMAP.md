...
- [x] **Phase 10: Provenance Signals** - Add "established across N sessions over M weeks" metadata at injection time (completed 2026-03-29)
...
- [x] **Phase 14: Replay Priority** - Sort observations by salience before presenting to consolidation LLM (completed 2026-03-29)
...
Plans:
- [ ] 11-01-PLAN.md — TDD OrientingDetector with correction, emphasis, error_spike, pacing_break signals + feature flag
