"""
Auto-generated eval for: prefers-parallel-sonnet-haiku-subagents
Description: 'User prefers parallelization with sonnet/haiku subagents'
...
EXPECTED_ENTITIES = ['parallelization', 'sonnet', 'haiku', 'subagents']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_prefers_parallel_sonnet_haiku_subagents_semantic_similarity():
    ...
    QUERY = 'parallelization sonnet haiku subagents'
