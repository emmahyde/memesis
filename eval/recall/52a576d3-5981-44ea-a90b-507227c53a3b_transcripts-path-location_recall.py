"""
Auto-generated eval for: transcripts-path-location
Description: 'Real Claude Code transcripts live at ~/.claude/projects not ~/.claude/transcripts'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-a0e42drv')
EXPECTED_ENTITIES = ['~/.claude/projects', '~/.claude/transcripts', 'Claude Code transcripts']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_transcripts_path_location_entity_presence():
