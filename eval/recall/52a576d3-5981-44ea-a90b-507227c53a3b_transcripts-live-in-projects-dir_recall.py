"""
Auto-generated eval for: transcripts-live-in-projects-dir
Description: 'Real Claude Code transcripts live at ~/.claude/projects/<slug>/<uuid>.jsonl not ~/.claude/transcripts/ which is a different flat-schema wispr voice format'
...
EXPECTED_ENTITIES = ['~/.claude/projects', 'jsonl', '~/.claude/transcripts', 'wispr']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_transcripts_live_in_projects_dir_entity_presence():
