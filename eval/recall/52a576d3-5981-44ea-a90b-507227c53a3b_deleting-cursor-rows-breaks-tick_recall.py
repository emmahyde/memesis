"""
Auto-generated eval for: deleting-cursor-rows-breaks-tick
Description: 'Emma corrected Claude that deleting cursor rows breaks tick'
...
EXPECTED_ENTITIES = ['cursor rows', 'tick', 'delete']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_deleting_cursor_rows_breaks_tick_semantic_similarity():
