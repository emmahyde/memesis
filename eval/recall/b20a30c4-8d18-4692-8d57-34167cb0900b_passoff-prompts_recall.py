"""
Auto-generated eval for: passoff-prompts
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-7e_7471l')
EXPECTED_ENTITIES = ['passoff prompts', 'user']
POLARITY = None
STAGE_TARGET = None
...
def test_passoff_prompts_semantic_similarity():
