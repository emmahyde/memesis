"""
Auto-generated eval for: subagent-passoff-prompt-detail
...
EXPECTED_ENTITIES = ['subagent', 'context', 'handoff', 'prompt']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_subagent_passoff_prompt_detail_semantic_similarity():
    ...
    QUERY = 'subagent context handoff prompt'
