"""
Auto-generated eval for: reset-cursors-set-offset-zero
Description: 'Emma corrected Claude that deleting cursor rows makes tick() EOF-seed new sessions and skip them, so the correct rollback is to set last_byte_offset=0 instead of deleting'
...
EXPECTED_ENTITIES = ['last_byte_offset', 'cursor', 'tick', 'rollback']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_reset_cursors_set_offset_zero_semantic_similarity():
    ...
    QUERY = 'last_byte_offset cursor tick rollback'
