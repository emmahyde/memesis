"""
Auto-generated eval for: native-instinctive-bypass-w5-enrichment
Description: 'Two memesis write paths bypass W5 schema enrichment: NativeMemoryIngestor in core/ingest.py and SelfReflector._create_instinctive_memory both wrote kind=None until fixed'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-tbrdz2yq')
EXPECTED_ENTITIES = ['NativeMemoryIngestor', 'SelfReflector._create_instinctive_memory', 'W5 enrichment', 'kind']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_native_instinctive_bypass_w5_enrichment_semantic_similarity():
    ...
    QUERY = 'NativeMemoryIngestor SelfReflector._create_instinctive_memory W5 enrichment kind'
