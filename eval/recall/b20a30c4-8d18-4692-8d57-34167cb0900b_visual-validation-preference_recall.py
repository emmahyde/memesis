"""
Auto-generated eval for: visual-validation-preference
Description: 'User often wants visual validation (screenshots, UI confirmation)'
...
EXPECTED_ENTITIES = ['screenshots', 'UI confirmation', 'visual validation']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_visual_validation_preference_semantic_similarity():
    ...
    QUERY = 'screenshots UI confirmation visual validation'
