"""
Auto-generated eval for: detailed-subagent-passoff-prompts
Description: 'Use detailed passoff prompts when handing off to subagents so they have full context without the conversation history'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-3m4sj3uv')
EXPECTED_ENTITIES = ['subagent', 'passoff', 'context', 'prompt']
POLARITY = None
STAGE_TARGET = None
...
def test_detailed_subagent_passoff_prompts_semantic_similarity():
    ...
    QUERY = 'subagent passoff context prompt'
