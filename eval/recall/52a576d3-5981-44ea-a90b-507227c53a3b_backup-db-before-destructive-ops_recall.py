"""
Auto-generated eval for: backup-db-before-destructive-ops
Description: 'Workflow pattern: cp index.db and cursors.db to timestamped backup before any destructive DELETE or schema operation'
...
EXPECTED_ENTITIES = ['index.db', 'cursors.db', 'backup', 'destructive operation']
POLARITY = 'neutral'
STAGE_TARGET = None
...
def test_backup_db_before_destructive_ops_semantic_similarity():
    ...
    QUERY = 'index.db cursors.db backup destructive operation'
