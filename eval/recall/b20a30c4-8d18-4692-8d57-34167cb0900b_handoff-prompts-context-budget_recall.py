"""
Auto-generated eval for: handoff-prompts-context-budget
Description: 'user crafts handoff/passoff prompts to start fresh sessions for context-budget management'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-0b1ed6wf')
EXPECTED_ENTITIES = ['handoff prompts', 'fresh sessions', 'context budget']
POLARITY = None
STAGE_TARGET = None
...
def test_handoff_prompts_context_budget_semantic_similarity():
    ...
    QUERY = 'handoff prompts fresh sessions context budget'
