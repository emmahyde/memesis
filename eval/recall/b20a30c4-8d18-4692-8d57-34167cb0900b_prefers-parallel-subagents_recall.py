"""
Auto-generated eval for: prefers-parallel-subagents
Description: 'User prefers parallelization with sonnet/haiku subagents rather than doing things in active session'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-1aszdor9')
EXPECTED_ENTITIES = ['parallelization', 'subagents', 'sonnet', 'haiku', 'active session']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_prefers_parallel_subagents_semantic_similarity():
    ...
    QUERY = 'parallelization subagents sonnet haiku active session'
