"""
Auto-generated eval for: native-ingestor-instinctive-seeder-kind
Description: 'Native ingestor and instinctive seeder both wrote kind=None until W5 mappings added'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-l5y2ywgq')
EXPECTED_ENTITIES = ['native ingestor', 'instinctive seeder', 'kind', 'W5 mappings']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_native_ingestor_instinctive_seeder_kind_semantic_similarity():
    ...
    QUERY = 'native ingestor instinctive seeder kind W5 mappings'
