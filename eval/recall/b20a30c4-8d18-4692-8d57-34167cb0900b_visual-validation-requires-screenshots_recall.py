"""
Auto-generated eval for: visual-validation-requires-screenshots
Description: 'Visual changes must be validated with screenshots before reporting success - not trusted from live eval alone'
...
EXPECTED_ENTITIES = ['screenshot', 'visual validation', 'live eval']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_visual_validation_requires_screenshots_semantic_similarity():
    ...
    QUERY = 'screenshot visual validation live eval'
