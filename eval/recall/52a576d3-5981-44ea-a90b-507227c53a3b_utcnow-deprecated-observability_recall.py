"""
Auto-generated eval for: utcnow-deprecated-observability
Description: 'datetime.utcnow() is deprecated in core/observability.py line 100; replace with datetime.now(datetime.UTC)'
...
EXPECTED_ENTITIES = ['datetime.utcnow', 'core/observability.py', 'datetime.now(datetime.UTC)']
POLARITY = 'corrective'
STAGE_TARGET = None
...
def test_utcnow_deprecated_observability_entity_presence():
