"""
Auto-generated eval for: prefers-dedicated-reset-scripts
Description: 'Emma prefers small dedicated reset scripts over CLI flags on existing scripts when adding rollback capability'
...
EXPECTED_ENTITIES = ['reset scripts', 'CLI flags', 'rollback']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_prefers_dedicated_reset_scripts_semantic_similarity():
    ...
    QUERY = 'reset scripts CLI flags rollback'
