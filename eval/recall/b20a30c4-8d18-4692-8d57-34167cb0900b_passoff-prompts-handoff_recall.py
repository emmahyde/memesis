"""
Auto-generated eval for: passoff-prompts-handoff
Description: 'User often creates passoff prompts to hand off to fresh sessions'
...
EXPECTED_ENTITIES = ['passoff prompts', 'handoff', 'fresh sessions']
POLARITY = None
STAGE_TARGET = None
...
def test_passoff_prompts_handoff_semantic_similarity():
    ...
    QUERY = 'passoff prompts handoff fresh sessions'
