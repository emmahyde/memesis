"""
Auto-generated eval for: prefers-durable-rollback-tooling
Description: 'Emma prefers durable rollback tooling like scripts/reset_cursors.py over ad-hoc one-off recovery commands'
...
EXPECTED_ENTITIES = ['rollback tooling', 'scripts/reset_cursors.py', 'ad-hoc recovery']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_prefers_durable_rollback_tooling_semantic_similarity():
    ...
    QUERY = 'rollback tooling scripts/reset_cursors.py ad-hoc recovery'
