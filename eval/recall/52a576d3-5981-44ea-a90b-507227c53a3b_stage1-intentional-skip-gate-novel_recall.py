"""
Auto-generated eval for: stage1-intentional-skip-gate-novel
Description: 'Stage 1 LLM correctly emits intentional skip with gate=novel on synthetic eval transcripts containing placeholder Fixed-async-issue content; zero observations is expected'
...
EXPECTED_ENTITIES = ['stage 1', 'intentional skip', 'gate=novel', 'zero observations']
POLARITY = None
STAGE_TARGET = None
...
def test_stage1_intentional_skip_gate_novel_semantic_similarity():
    ...
    QUERY = 'stage 1 intentional skip gate=novel zero observations'
