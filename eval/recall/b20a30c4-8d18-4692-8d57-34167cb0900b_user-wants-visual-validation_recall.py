"""
Auto-generated eval for: user-wants-visual-validation
Description: 'User wants visual validation'
...
EXPECTED_ENTITIES = ['visual validation', 'screenshot', 'UI verification']
POLARITY = 'positive'
STAGE_TARGET = None
...
def test_user_wants_visual_validation_semantic_similarity():
    ...
    QUERY = 'visual validation screenshot UI verification'
