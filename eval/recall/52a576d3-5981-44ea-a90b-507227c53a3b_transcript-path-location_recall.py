"""
Auto-generated eval for: transcript-path-location
Description: 'transcript path location'
...
REPLAY_STORE_PATH = os.environ.get("MEMESIS_REPLAY_STORE", '/var/folders/1m/fmknnw9n3cxf_slfs6sw832h0000gn/T/memesis-replay-kzne6l6c')
EXPECTED_ENTITIES = ['transcript', 'path', 'location']
POLARITY = None
STAGE_TARGET = None
...
def test_transcript_path_location_semantic_similarity():
    ...
    QUERY = 'transcript path location'
